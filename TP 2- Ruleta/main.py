...
if __name__ == "__main__":
    ...
    for cajaInicial in valoresCaja:
        ...
        graficarMultiples(listaProm, constante(cajaInicial, 100), "n(numero de tiradas)", "ccp(cantidad de capital promedio)", "Flujo de caja promedio de todas las corridas. " + nombreCaja) 
